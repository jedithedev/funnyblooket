...
function swap() {
    ...
    reactHandler().stateNode.setState({ choices : {0 : {'blook' : 'Angry Blook', 'val' : 100, 'text' : 'Swap', 'type' : 'swap'}, 1 : {'blook' : 'Angry Blook', 'val' : 100, 'text' : 'Swap', 'type' : 'swap'}, 2 : {'blook' : 'Angry Blook', 'val' : 100, 'text' : 'Swap', 'type' : 'swap'}}});
}
